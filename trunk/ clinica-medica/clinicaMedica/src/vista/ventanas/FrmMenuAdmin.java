...
public class FrmMenuAdmin extends UnicastRemoteObject implements IObserver{
	 ...
	 * @throws Throwable 
	 */
	public FrmMenuAdmin(CdorMenuAdmin control)throws Throwable {
		cdor = control;
	...
	private JButton getjButton2() {
		if (jButton2 == null) {
			...
			jButton2.setBounds(new Rectangle(108, 140, 200, 30));
	...
	private JButton getJButton4() {
		if (jButton4 == null) {
			...
			jButton4.setBounds(new Rectangle(108, 195, 200, 30));
	...
	private JButton getJButton5() {
		if (jButton5 == null) {
			...
			jButton5.setBounds(new Rectangle(108, 250, 200, 30));
	...
	private JButton getJButton6() {
		if (jButton6 == null) {
			...
			jButton6.setBounds(new Rectangle(108, 310, 200, 30));
	...
	private JButton getJButton7() {
		if (jButton7 == null) {
			...
			jButton7.setBounds(new Rectangle(108, 370, 200, 30));
