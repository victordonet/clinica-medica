...
public class FrmSelecAfiliado extends UnicastRemoteObject implements IObserver{
	 ...
	 * @throws Throwable
	 */
	public FrmSelecAfiliado(ModeloTablaListEsp modelo, CdorListadoEsp control)throws Throwable {
		this.modelo = modelo;
		cdor = control;
		initialize();
	}
	...
	private PanelConImagen getJContentPane() throws Throwable, ClassNotFoundException {
		//if (jContentPane == null) {
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(209, 14, 176, 24));
			jLabel.setForeground(new java.awt.Color(118,144,201));
			jLabel.setText("Selección de Afiliado");
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setText("Aceptar Selección Afiliado.");
	...
	private JButton getJButton21() {
		if (jButton21 == null) {
			...
			jButton21.setText("Cancelar Selección Afiliado.");
