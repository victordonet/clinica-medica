...
public class FrmListadoAdmin extends UnicastRemoteObject implements IObserver{
	...
	private PanelConImagen getJContentPane() throws Throwable, ClassNotFoundException {
		//if (jContentPane == null) {
			jLabel = new JLabel();
			jLabel.setBounds(new Rectangle(185, 15, 216, 24));
			jLabel.setForeground(new java.awt.Color(118,144,201));
			jLabel.setText("Listado de Administrativos");
