...
public class FrmMenuAdmin extends UnicastRemoteObject implements IObserver{
	 ...
	 * @throws Throwable 
	 */
	public FrmMenuAdmin(CdorMenuAdmin cdorMenuAdmin)throws Throwable {
		cdor = cdorMenuAdmin;
		this.modelo = cdor.listarConsultas();
		initialize();
	}
	...
	private JTable getJTable1() {
		if (jTable1 == null) {
			...
			jTable1.setBounds(new Rectangle(94, 495, 283, 182));
		}
		return jTable1;
	}
	...
	private JButton getjButton2() {
		if (jButton2 == null) {
			...
			jButton2.setBounds(new Rectangle(124, 169, 216, 35));
	...
	private JButton getJButton4() {
		if (jButton4 == null) {
			...
			jButton4.setBounds(new Rectangle(124, 232, 216, 35));
	...
	private JButton getJButton5() {
		if (jButton5 == null) {
			...
			jButton5.setBounds(new Rectangle(124, 293, 216, 35));
	...
	private JButton getJButton6() {
		if (jButton6 == null) {
			...
			jButton6.setBounds(new Rectangle(124, 355, 216, 35));
