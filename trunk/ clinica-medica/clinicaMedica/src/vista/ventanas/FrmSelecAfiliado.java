...
import vista.controladores.CdorSelectAfi;
import vista.controladores.ModeloTablaListAfil;

public class FrmSelecAfiliado extends JFrame {
	 ...
	 * @throws Throwable
	 */
	public FrmSelecAfiliado(CdorSelectAfi cdorSelectAfi)throws Throwable {
		cdor = cdorSelectAfi;
		initialize();
	}
		...
		if (jButton2 == null) {
			...
			jButton2.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					System.out.println("Aceptar selectción medicos");
