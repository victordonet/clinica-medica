...
<tr height="100%">
    ...
    <td valign="top"><input type="button" name="Listado" value="Listado de Consultas" style="height:50px; width:200px" onClick="window.location='listadoConsultasAfi.jsp'"></td>
