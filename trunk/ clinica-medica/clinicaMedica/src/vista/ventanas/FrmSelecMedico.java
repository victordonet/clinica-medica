...
import vista.controladores.CdorSelectMed;
import vista.controladores.ModeloTablaListMed;

public class FrmSelecMedico extends JFrame{
		...
		if (jButton2 == null) {
			...
			jButton2.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					String id = cdor.getvMed().get(jTable1.getSelectedRow()).getId();
					cdor.setId(id);
					cdor.actionAceptar();
				}
			});
