...
public class FrmSelecExamen extends UnicastRemoteObject implements IObserver{
	 ...
	 * @throws Throwable
	 */
	public FrmSelecExamen(ModeloTablaListEsp modelo, CdorListadoEsp control)throws Throwable {
		this.modelo = modelo;
		cdor = control;
		initialize();
	}
	...
	private JButton getJButton2() {
		if (jButton2 == null) {
			...
			jButton2.setText("Aceptar Selección Exámen.");
	...
	private JButton getJButton21() {
		if (jButton21 == null) {
			...
			jButton21.setText("Cancelar Selección Exámen.");
