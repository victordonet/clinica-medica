...
public class FrmParaclinica extends JFrame {
	...
	private void initialize() {
		this.setSize(new java.awt.Dimension(717,468));
		this.setLocation(520,140);
	...
	private JButton getbtGuardar() {
		if (btGuardar == null) {
			...
			btGuardar.setBounds(new Rectangle(662, 393, 40, 40));
	...
	private JButton getbtCancelar() {
		if (btCancelar == null) {
			...
			btCancelar.setBounds(new Rectangle(612, 393, 40, 40));
	...
	private JRadioButton getRdoLinea_1() {
		if (rdoLinea_1 == null) {
			...
			rdoLinea_1.setBounds(new Rectangle(241, 146, 100, 22));
	...
	private JRadioButton getRdoLinea_2() {
		if (rdoLinea_2 == null) {
			...
			rdoLinea_2.setBounds(new Rectangle(241, 171, 76, 22));
	...
	private JRadioButton getRdoLinea_3() {
		if (rdoLinea_3 == null) {
			...
			rdoLinea_3.setBounds(new Rectangle(241, 196, 86, 22));
	...
	private JTextField getTxtLinea() {
		if (txtLinea == null) {
			...
			txtLinea.setBounds(new Rectangle(328, 180, 38, 22));
	...
	private JRadioButton getRdoEco_1() {
		if (rdoEco_1 == null) {
			...
			rdoEco_1.setBounds(new Rectangle(10, 121, 50, 22));
	...
	private JRadioButton getRdoEco_2() {
		if (rdoEco_2 == null) {
			...
			rdoEco_2.setBounds(new Rectangle(10, 146, 110, 22));
	...
	private JRadioButton getRdoEco_3() {
		if (rdoEco_3 == null) {
			...
			rdoEco_3.setBounds(new Rectangle(10, 171, 122, 22));
	...
	private JRadioButton getRdoEco_4() {
		if (rdoEco_4 == null) {
			...
			rdoEco_4.setBounds(new Rectangle(10, 196, 157, 22));
	...
	private JRadioButton getRdoImg_1() {
		if (rdoImg_1 == null) {
			...
			rdoImg_1.setBounds(new Rectangle(462, 146, 130, 22));
	...
	private JRadioButton getRdoImg_2() {
		if (rdoImg_2 == null) {
			...
			rdoImg_2.setBounds(new Rectangle(462, 171, 130, 22));
	...
	private JTextField getTxtOtras() {
		if (txtOtras == null) {
			...
			txtOtras.setBounds(new Rectangle(102, 400, 186, 22));
	...
	private JCheckBox getChkHSG_RX_1() {
		if (chkHSG_RX_1 == null) {
			...
			chkHSG_RX_1.setBounds(new Rectangle(12, 279, 22, 22));
	...
	private JCheckBox getChkHSG_RX_2() {
		if (chkHSG_RX_2 == null) {
			...
			chkHSG_RX_2.setBounds(new Rectangle(12, 299, 22, 22));
	...
	private JCheckBox getChkHSG_RX_3() {
		if (chkHSG_RX_3 == null) {
			...
			chkHSG_RX_3.setBounds(new Rectangle(12, 319, 22, 22));
	...
	private JCheckBox getChkHSG_RX_4() {
		if (chkHSG_RX_4 == null) {
			...
			chkHSG_RX_4.setBounds(new Rectangle(12, 339, 22, 22));
	...
	private JCheckBox getChkHSG_RX_5() {
		if (chkHSG_RX_5 == null) {
			...
			chkHSG_RX_5.setBounds(new Rectangle(12, 359, 22, 22));
	...
	private JCheckBox getChkHSG_RX_6() {
		if (chkHSG_RX_6 == null) {
			...
			chkHSG_RX_6.setBounds(new Rectangle(12, 379, 22, 22));
	...
	private JCheckBox getChkHSG_ECO_1() {
		if (chkHSG_ECO_1 == null) {
			...
			chkHSG_ECO_1.setBounds(new Rectangle(40, 279, 53, 22));
	...
	private JCheckBox getChkHSG_ECO_2() {
		if (chkHSG_ECO_2 == null) {
			...
			chkHSG_ECO_2.setBounds(new Rectangle(40, 299, 102, 22));
	...
	private JCheckBox getChkHSG_ECO_3() {
		if (chkHSG_ECO_3 == null) {
			...
			chkHSG_ECO_3.setBounds(new Rectangle(40, 319, 142, 22));
	...
	private JCheckBox getChkHSG_ECO_4() {
		if (chkHSG_ECO_4 == null) {
			...
			chkHSG_ECO_4.setBounds(new Rectangle(40, 339, 130, 22));
	...
	private JCheckBox getChkHSG_ECO_5() {
		if (chkHSG_ECO_5 == null) {
			...
			chkHSG_ECO_5.setBounds(new Rectangle(40, 359, 81, 22));
	...
	private JCheckBox getChkHSG_ECO_6() {
		if (chkHSG_ECO_6 == null) {
			...
			chkHSG_ECO_6.setBounds(new Rectangle(40, 379, 133, 22));
