...
public class FrmAnatomia extends JFrame {
	...
	private JRadioButton getRdoCorr_1() {
		if (rdoCorr_1 == null) {
			...
			rdoCorr_1.setBounds(new Rectangle(17, 394, 50, 22));
	...
	private JRadioButton getRdoCorr_2() {
		if (rdoCorr_2 == null) {
			...
			rdoCorr_2.setBounds(new Rectangle(69, 394, 50, 22));
	...
	private JTextField getTxtOtros_1() {
		if (txtOtros_1 == null) {
			...
			txtOtros_1.setBounds(new Rectangle(260, 163, 149, 21));
	...
	private JTextField getTxtOtros_2() {
		if (txtOtros_2 == null) {
			...
			txtOtros_2.setBounds(new Rectangle(260, 323, 143, 22));
